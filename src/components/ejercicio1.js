...
class Ejercicio1 extends Component {
  ...
  cambioNumero = (event, act) => {
    this.setState({
      [act]: Number(event.target.value), // Actualizamos el estado dinámicamente
    });
  };
    ...
    return (
      <div>
        ...
        <input
          ...
          onChange={(e) => this.cambioNumero(e, 'numero1')} // Actualizamos numero1 cuando el usuario escribe algo
        />
        ...
        <input
          ...
          onChange={(e) => this.cambioNumero(e, 'numero2')} // Actualizamos numero2 cuando el usuario escribe algo
        />
